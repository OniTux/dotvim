...
inoremap <S-Tab> =MultipleAutoCompletion()
imap <F6> :call CleanCode()i
imap <M-Up> gki
imap <M-Down> gji
imap <F1> :call HelpMemory()i
nnoremap  zm
nmap  
nnoremap   zA
map * :exe '2match Search /' . expand('<cWORD>') . '/':exe '/' . expand('<cWORD>') .'/'
imap  /<+.\{-1,}+>c/+>/e
nnoremap C zr
map Q :confirm qa
vmap [% [%m'gv``
...
map <C-PageUp> :cnext:exe '2match Search /' . expand('<cWORD>') . '/'
map <F12> :call LoadSession()
map <F11> :call SaveSession()
map <C-Up> [/
map <C-Down> ]/
map <F8> :TlistToggle
map <F9> :NERDTreeToggle
map <F5> :call ToggleMouseActivation()
map <F6> :call CleanCode()
map <S-F7> :call JumpToSign()
map <M-F7> :exe ':sign unplace'
map <F7> :call MarkSign()
map <M-Up> gk
map <M-Down> gj
nmap <BS> 
map <F1> :call HelpMemory()
map <S-Right> :call MoveTab('right')
map <S-Left> :call MoveTab('left')
map <C-Right> :tabnext
map <C-Left> :tabprevious
inoremap  u
map  /<+.\{-1,}+>c/+>/e
map ù :exe '2match Search /' . expand('<cWORD>') . '/':exe '?' . expand('<cWORD>') .'?'
imap Q :confirm qa
imap \ihn :IHN
imap \is :IHS:A
imap \ih :IHS
